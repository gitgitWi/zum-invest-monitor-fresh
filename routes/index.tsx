...
const styles = {
  ...
  title:
    'w-full h-1/3 mb-2 flex justify-center items-end \
  font-extrabold text-4xl text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-green-500 \
  select-none cursor-default',
  pagesHeader:
    'font-semibold text-xl align-middle text-gray-500 cursor-default',
  pageLinkContainer: 'w-full pt-4 flex flex-col justify-center items-center',
  pageLink:
  ...
  return (
    <>
      ...
      <body class={styles.body}>
        <h1 class={[styles.title].join(' ')}>Watch Invest Zum</h1>
        <main class={styles.main}>
          <h2 class={styles.pagesHeader}>Validator Pages</h2>
          <div class={styles.pageLinkContainer}>
